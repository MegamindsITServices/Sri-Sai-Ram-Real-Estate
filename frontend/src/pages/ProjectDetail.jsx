      ...
      /> */}
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="w-full md:w-[50%] ">
                <div
                  className="w-full h-60 md:h-80 inset-0   rounded-lg shadow-md bg-cover bg-no-repeat bg-center"
    ...
    >
      {project.location}
                  ...
                  <p className="  flex gap-3 items-center pl-1 ">
                    ...
                    <p className="font-thin">Starting plot price:</p>{" "}
                  ...
                  <button
                    className="mont mt-5 border-2 flex items-center rounded-md border-blue-500 px-5 py-3 font-semibold text-blue-600 "
                    onClick={() => {
